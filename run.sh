...
./eb-api/bin/elastic-beanstalk-create-application-version -a $WERCKER_KODING_EB_DEPLOY_APP_NAME -l $WERCKER_KODING_EB_DEPLOY_VERSION_LABEL -s $WERCKER_KODING_EB_DEPLOY_BUCKET
